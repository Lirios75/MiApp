...
- carrusel "La app por dentro": RESUELTO (2026-09-21) — los 4 placeholders se reemplazaron por capturas reales de la app en `public/images/app-por-dentro/` (registro-diario.png = Hoy sin marcar, metas.png = Tu meta con el anillo, pantalla-principal.png = Hoy confirmado con racha, reporte-semanal.png = Semana). Verificado en el navegador (docs/revisiones/vivo/landing-carrusel-app.png). Sigue pendiente el mismo tratamiento para el placeholder del Hero (aún dashed, sugerencia "captura de tu pantalla principal con el anillo de tu meta y tu racha") — no es un defecto (es un placeholder honesto legítimo), pero sería una mejora natural si se retoca la landing.

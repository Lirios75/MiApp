...
- veredicto:landing — 1ª pasada NO LISTA (usabilidad 27/40, craft 13/20): 5 defectos corregidos (rutas 404, contraste AA, hairline entre secciones, anillo de marca, CTAs unificados). 2ª pasada: usabilidad 36/40 ✅ (cruza el piso), craft 14/20 ❌ (falta 2 — el eje Movimiento estaba en 2/4). Se agregó movimiento real: RespiraMark anima su relleno al entrar en vista, los precios de la Oferta cuentan desde 0, y un eco grande y sutil del anillo en el fondo del Hero. Se relanzó el revisor-visual para la 3ª pasada — veredicto pendiente.

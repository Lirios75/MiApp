...
- veredicto onboarding PENDIENTE de certificación formal (Sesión 4, en construcción) — última pasada leída (11ª): usabilidad 34/40, craft 14/20 — gate exige ≥36/40 y ≥16/20, sigue NO LISTA tras 11 rondas pero MUY cerca en usabilidad. Se corrigieron los 2 defectos de esa pasada (bounce 0.4-0.5 fuera de espec de FICHA-ARTE → 0.15; celebración seguía siendo el tramo más vacío → frase de refuerzo bajo el tracker semanal) y se relanzó una 12ª pasada, resultado aún no leído.
- veredicto paywall PENDIENTE de certificación formal (Sesión 4, en construcción) — última pasada leída (11ª): usabilidad 31/40 (bajó de 33 por 2 hallazgos nuevos), craft 19/20 y copy 19/20 YA PASAN CON MARGEN desde hace varias rondas. Se corrigieron los 5 defectos de esa pasada (aria-label distinto entre fases del botón X → unificado; plan Anual/Mensual sin estado accesible → role="radio"+aria-checked; card Mensual con tratamiento distinto a Anual → mismo Hairline en ambas; LoadingPlan y ConfirmSalir con tamaños fuera de la escala de 4 niveles → consolidados) y se relanzó una 12ª pasada, resultado aún no leído.

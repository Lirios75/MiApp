...
- veredicto onboarding PENDIENTE de certificación formal (Sesión 4, en construcción) — última pasada leída (10ª): usabilidad 28/40, craft 14/20 — gate exige ≥36/40 y ≥16/20, sigue NO LISTA tras 10 rondas. El usuario, informado de la disyuntiva (aceptar así vs. seguir puliendo), eligió seguir puliendo — se corrigieron los 2 defectos puntuales que quedaban (VistaSemaforo repetida idéntica en las 4 preguntas → ahora varía por paso; celebración con el vacío más grande del onboarding → ahora extiende el tracker semanal marcando el día de hoy) y se relanzó una 11ª pasada, resultado aún no leído al momento de este checkpoint. No declarar esta pantalla "lista" hasta que el veredicto diga LISTA o el usuario acepte una disyuntiva explícita.
- veredicto paywall PENDIENTE de certificación formal (Sesión 4, en construcción) — última pasada leída (10ª): usabilidad 33/40 (gate ≥36/40, muy cerca) — craft 19/20 y copy 19/20 YA PASAN CON MARGEN desde hace varias rondas. Se corrigieron los 3 defectos concretos de esa pasada (X saltaba de lado entre fases → unificado a la derecha; 8 tamaños de fuente vs. la escala de 4 niveles de FICHA-ARTE → consolidados; ConfirmSalir sin trap de foco → ahora cicla Tab entre sus 2 botones) y se relanzó una 11ª pasada, resultado aún no leído al momento de este checkpoint. No declarar esta pantalla "lista" hasta que el veredicto diga LISTA o el usuario acepte una disyuntiva explícita.
